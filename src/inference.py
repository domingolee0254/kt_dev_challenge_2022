...
from utils import score_function, seed_everything
...
if __name__ == '__main__':
    ...
    parser.add_argument('-tdd', '--test_data_dir', type=str, default='/home/work/team01/food-kt/data/test')
    ...
    if args.mode == 'no_label':  # w/o label
        test_data = sorted(glob(f'{args.test_data_dir}/*.jpg'))
