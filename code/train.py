...
if __name__ == '__main__':
    ...
    parser.add_argument('-sd', '--save_dir', type=str, default='/home/work/team01/food-kt/ckpt')
    ...
    parser.add_argument('-we', '--warm_epoch', type=int, default=10)
    ...
    run = None
    if args.wandb:
        wandb_api_key = os.environ.get('b3da14bc9f7955195a286da709f9eb3102a27e3e') #wonil wandb key
